...
@section('section')
    ...
    <div class="col-sm-12">
        ...
        {{-- INI Collapsible Card --}}
        @component('elements.widgets.collapse')
            @slot('id', 'home_card')
            @slot('class', 'info')
            @slot('header', 'Widgets')
            @slot('body')
            ...
            @endslot
        @endcomponent
        {{-- FIN Collapsible Card --}}

        {{-- INI Collapsible Chart --}}
        @component('elements.widgets.collapse')
            @slot('id', 'home_chart')
            @slot('class', 'success')
            @slot('header', 'Gráficas')
            @slot('body')
            ...
            @endslot
        @endcomponent
        {{-- FIN Collapsible Chart --}}

        {{-- INI Collapsible Tables --}}
        @component('elements.widgets.collapse')
            @slot('id', 'home_table')
            @slot('class', 'warning')
            @slot('header', 'Tablas')
